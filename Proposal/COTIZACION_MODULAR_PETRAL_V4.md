...
@page {
    ...
    margin: 30mm 15mm 20mm 15mm !important;
}
.header-print {
    position: fixed;
    top: -20mm;
...
.tabla-comparativa th {
    padding: 8px 10px; border: 1px solid #0f2c59; font-size: 11pt; background-color: #0f2c59; color: white;
}
...
.col-horas { width: 5%; text-align: center; }
...
<div style="page-break-after: always; padding-top: 5px;">
    <h2 style="margin-top: 0;">Inversión Única (One-Timers) - Parte 1</h2>
    <table class="tabla-comparativa">
        ...
        <tbody>
            <tr style="background-color: rgba(15, 44, 89, 0.05);">
                ...
                <td style="font-weight: bold; color: #475569; text-align: center;">125</td>
                <td style="font-weight: bold; color: #475569; text-align: center;">10</td>
                <td style="font-weight: bold; color: #475569; text-align: center;">1,250</td>
            </tr>
            <tr style="background-color: #ffffff;">
                ...
                <td style="font-weight: bold; color: #475569; text-align: center;">80</td>
                <td style="font-weight: bold; color: #475569; text-align: center;">4,000</td>
            </tr>
        </tbody>
    </table>
</div>
...
<div style="page-break-after: always; padding-top: 5px;">
    <h2 style="margin-top: 0;">Inversión Única (One-Timers) - Parte 2</h2>
    <table class="tabla-comparativa">
        <thead>
            <tr>
                <th class="col-etapa">Etapa</th>
        ...
        <tbody>
            ...
            <tr style="background-color: #0f2c59; color: white;">
                <td colspan="5" style="padding: 12px; border: 1px solid #0f2c59; font-weight: bold; text-align: right; font-size: 13pt;">TOTAL INVERSIÓN (Sin IGV):</td>
                <td style="padding: 12px; border: 1px solid #0f2c59; font-weight: bold; text-align: center; font-size: 13pt;">$ 6,750</td>
            </tr>
        </tbody>
    </table>
</div>
...
<div style="padding-top: 5px;">
    <h2 style="margin-top: 0;">Costos Recurrentes (Operatividad)</h2>
    <table class="tabla-comparativa">
        <thead>
            <tr>
                <th class="col-etapa">Etapa</th>
