...
def generate_etl_flowchart():
    base_name = "FLUJOGRAMA_ETL_Supabase_V3"
    output_filename = base_name
    
    print(f"Generando Flujograma ETL V3: {output_filename}.pdf")
    ...
    digraph ETLFlow {
        ...
        # Para hacerlo angosto globalmente
        ratio=auto;
        ...
        subgraph cluster_lvl1 {
            ...
            subgraph cluster_files {
                ...
                # Cajas separadas horizontalmente con sus autores
                {rank=same;
        ...
        subgraph cluster_lvl2 {
            ...
            subgraph cluster_parsers {
                ...
                # Forzar apilamiento vertical para mantener el formato angosto abajo
