...
from backend.port_engines import calculator_mejillones_interacid

print("=" * 80)
print(" *** SANITY CHECK EMPIRICO: TERMINAL INTERACID (MEJILLONES - CHILE) ***")
print("=" * 80)
...
for vessel in fleet:
    ...
    assert diff < 2.0, f"ERROR en Interacid para {vname}: Obtenido ${calculated:,.2f} vs Esperado ${expected:,.2f}"
    print(f" [OK] {vname} Coincide 100% centavo a centavo")

print("\n" + "=" * 80)
print(" [EXITO TOTAL SANITY CHECK] MOTOR DE TERMINAL INTERACID COINCIDE 100% CON LA IMAGEN DE LA EXPERTA")
print("=" * 80)
