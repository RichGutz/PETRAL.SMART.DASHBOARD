...
for idx, tr in enumerate(tramos):
    ...
    tr["origin_action"] = p_orig.get("action", "NONE")
...
print("--- 100% PERFECT MATCH TEST RESULT ---")
print("bunker_costs:", res["consolidated"].get("total_bunker_costs"))
print("port_costs:", res["consolidated"].get("total_port_costs"))
print("total_refacturacion_muellaje:", res["consolidated"].get("total_refacturacion_muellaje"))
