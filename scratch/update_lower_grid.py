...
start_marker = '{/* 3. RESUMEN FINANCIERO Y OPERATIVO INFERIOR (4 COLUMNAS PARALELAS) */}'
...
if s_pos != -1 and e_pos != -1:
    new_grid_jsx = """{/* 3. RESUMEN FINANCIERO Y OPERATIVO INFERIOR (4 COLUMNAS PARALELAS Y GRID RESTRUCTURADO) */}
    ...
    with open(path, 'w', encoding='utf-8') as f:
        f.write(content)
    print("SUCCESSFULLY UPDATED LOWER GRID LAYOUT")
else:
