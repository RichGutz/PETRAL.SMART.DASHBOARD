...
from backend.port_engines import calculator_barquito

print("=" * 80)
print(" *** SANITY CHECK EMPIRICO: TERMINAL BARQUITO (CHAÑARAL - CHILE) ***")
print("=" * 80)
...
for vessel in fleet:
    ...
    assert diff < 2.0, f"ERROR en Barquito para {vname}: Obtenido ${calculated:,.2f} vs Esperado ${expected:,.2f}"
    print(f" [OK] {vname} Coincide 100% centavo a centavo")

print("\n" + "=" * 80)
print(" [EXITO TOTAL SANITY CHECK] MOTOR DE TERMINAL BARQUITO COINCIDE 100% CON LA IMAGEN DE LA EXPERTA")
print("=" * 80)
