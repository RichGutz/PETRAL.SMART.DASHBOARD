...
from backend.port_engines import calculator_mejillones_terquim

print("=" * 80)
print(" *** SANITY CHECK EMPIRICO: TERMINAL TERQUIM (MEJILLONES - CHILE) ***")
print("=" * 80)
...
for vessel in fleet:
    ...
    assert diff < 2.0, f"ERROR en Terquim para {vname}: Obtenido ${calculated:,.2f} vs Esperado ${expected:,.2f}"
    print(f" [OK] {vname} Coincide 100% centavo a centavo")

print("\n" + "=" * 80)
print(" [EXITO TOTAL SANITY CHECK] MOTOR DE TERMINAL TERQUIM COINCIDE 100% CON LA IMAGEN DE LA EXPERTA")
print("=" * 80)
