...
def generate_multicotizador_flowchart():
    base_name = "FLUJOGRAMA_Arquitectura_Multicotizador_V2"
    ...
    dot_content = """digraph MulticotizadorCascadeV2 {
    rankdir=TB;
    newrank=true;
    splines=polyline;
    nodesep=0.9;
    ...
    subgraph cluster_lvl6 {
        ...
        QC_Pass [label="✅ CONVERGENCIA ABSOLUTA 100%\\n(Delta = 0.000000 | 10 Rondas Auditas Impolutas)", shape=note, fillcolor="#C8E6C9", penwidth=2];
