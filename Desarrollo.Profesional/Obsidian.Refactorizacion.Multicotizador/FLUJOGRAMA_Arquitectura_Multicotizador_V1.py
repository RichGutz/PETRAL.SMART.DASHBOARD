...
def generate_multicotizador_flowchart():
    ...
    print(f"Generando Flujograma con Capa 1 en Fila Horizontal: {base_name}...")
    ...
    subgraph cluster_lvl1 {
        ...
        { rank=same; DB_Vessels; DB_Ports; DB_PortCosts; DB_Bunker; }
    ...
    subgraph cluster_lvl2 {
        ...
        { rank=same; S_Vessel; S_Bunker; S_Route; S_Port; }
