...
def generate_multicotizador_flowchart():
    ...
    subgraph cluster_lvl1 {
        ...
        { rank=same; DB_Vessels; DB_RoutesClients; DB_PortCosts; DB_Bunker; DB_RoutesQuotes; }
        ...
        DB_Vessels -> DB_RoutesClients -> DB_PortCosts -> DB_Bunker -> DB_RoutesQuotes [style=invis];
    }
    ...
    subgraph cluster_lvl3 {
        label = "NIVEL 3: GRILLA Y INTERFAZ DE USUARIO (MultiCotizadorExcel.tsx - 626 LOC)"; 
    ...
    S_Retriever -> UI_SaveModal [label=" Cargar Prospecto", color="#2E7D32", penwidth=2];
    ...
    S_Storage -> API_SaveEndpoint [label=" /spot/save (routes_quotes / routes_clients)", color="#2E7D32", penwidth=2];
