...
<table id="forecast-grid-table">
  ...
  <tbody>
    <tr>
      <td rowspan="12" class="bg-sky-700 text-white"><div class="vertical-text">SPCC</div></td>
      <td rowspan="12" class="bg-purple-500 text-white"><div class="vertical-text">ILO-CALLAO</div></td>
      <td rowspan="12" class="bg-green-600 text-white"><div class="vertical-text">MOQUEGUA</div></td>
    ...
    <tr><td>  ↳ Flete Marítimo</td><td>$295,000</td><td>$295,000</td><td>$295,000</td><td>$295,000</td><td>$295,000</td><td>$295,000</td><td>$295,000</td><td>$295,000</td><td>$295,000</td><td>$295,000</td><td>$295,000</td><td>$295,000</td><td>$3,540,000</td></tr>
    ...
    <tr><td>  ↳ Refacturación de Muellaje</td><td>$6,850</td><td>$6,850</td><td>$6,850</td><td>$6,850</td><td>$6,850</td><td>$6,850</td><td>$6,850</td><td>$6,850</td><td>$6,850</td><td>$6,850</td><td>$6,850</td><td>$6,850</td><td>$82,200</td></tr>
    <tr><td>COSTOS DIRECTOS DE VIAJE</td><td>$150,000</td><td>$150,000</td><td>$150,000</td><td>$150,000</td><td>$150,000</td><td>$150,000</td><td>$150,000</td><td>$150,000</td><td>$150,000</td><td>$150,000</td><td>$150,000</td><td>$150,000</td><td>$1,800,000</td></tr>
    <tr><td>  ↳ COMBUSTIBLES</td><td>$60,000</td><td>$60,000</td><td>$60,000</td><td>$60,000</td><td>$60,000</td><td>$60,000</td><td>$60,000</td><td>$60,000</td><td>$60,000</td><td>$60,000</td><td>$60,000</td><td>$60,000</td><td>$720,000</td></tr>
    ...
    <tr><td>MARGEN BRUTO (%)</td><td>27.4%</td><td>27.4%</td><td>27.4%</td><td>27.4%</td><td>27.4%</td><td>27.4%</td><td>27.4%</td><td>27.4%</td><td>27.4%</td><td>27.4%</td><td>27.4%</td><td>27.4%</td><td>27.4%</td></tr>
  </tbody>
</table>
</body>
</html>
...
const dom = new JSDOM(navHtmlContent);
const table = dom.window.document.getElementById('forecast-grid-table');

async function testExportNavitranso() {
    ...
    if (tbody) {
        tbody.querySelectorAll('tr').forEach(tr => {
            ...
            tr.querySelectorAll('td').forEach(td => {
                ...
                const textValue = (td.querySelector('.vertical-text')?.textContent || td.textContent || '').trim();
        ...
        col.eachCell({ includeEmpty: false }, (cell, rowIdx) => {
            if (rowIdx === 1) maxVisualLen = Math.max(maxVisualLen, String(cell.value || '').trim().length);
                ...
                if (typeof cell.value === 'number') {
                    ...
                    if (fmt.includes('%')) visualLen = ((num * 100).toFixed(1) + '%').length;
    ...
    await wb.xlsx.writeFile('test_navitranso_matrix_qc.xlsx');
    console.log('✅ Archivo test_navitranso_matrix_qc.xlsx generado con éxito.');
}

testExportNavitranso();
