...
export const LiquidationsExecutivePdfAudit_legacy: React.FC<LiquidationsExecutivePdfAuditProps> = ({ liquidations }) => {
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0;">
                        ...
                        <div style="padding: 10px; border-right: 2px solid #0f172a; background: #fafafa;">
                            ...
                            <table style="width: 100%; border-collapse: collapse; font-size: 14.5px;">
                                ...
                                <tr style="background: #fdf2f8; border-top: 1px dashed #f472b6;">
                                    ...
                                    <td style="text-align: right; color: #831843; font-weight: bold; padding: 2px 2px; font-size: 13.5px;">${estPortDays.toFixed(2)}d (${totalPortHrsEst.toFixed(1)}h)</td>
                                </tr>
                                <tr style="background: #fdf2f8;">
                                    <td style="color: #831843; font-weight: bold; padding: 2px 2px; font-size: 12.5px; padding-left: 16px;">└─ Puerto Carga Est (${loadPortName}):</td>
                                ...
                                <tr style="background: #fdf2f8;">
                                    <td style="color: #831843; font-weight: bold; padding: 2px 2px; font-size: 12.5px; padding-left: 16px;">└─ Puerto Descarga 1 Est (${dischPort1Name}):</td>
                                ...
                                ${dischPort2Name ? `
                                <tr style="background: #fdf2f8;">
                                    <td style="color: #831843; font-weight: bold; padding: 2px 2px; font-size: 12.5px; padding-left: 16px;">└─ Puerto Descarga 2 Est (${dischPort2Name}):</td>
                                ...
                                <tr style="background: #fdf2f8;">
                                    <td style="color: #6b21a8; font-weight: bold; padding: 1px 2px; font-size: 11.5px; padding-left: 28px;">📅 Fecha/Hora Arribo (${dischPort2Name}):</td>
                                    <td style="text-align: right; color: #6b21a8; font-weight: bold; padding: 1px 2px; font-size: 11.5px;">${fmtDateTime(disch2DateTime)}</td>
                                </tr>` : ''}
                        ...
                        <div style="padding: 10px; background: #ffffff;">
                            ...
                            <table style="width: 100%; border-collapse: collapse; font-size: 14.5px;">
                                ...
                                ${dischPort2Name ? `
                                <tr style="background: #fdf2f8;">
                                    <td style="color: #831843; font-weight: bold; padding: 2px 2px; font-size: 12.5px; padding-left: 16px;">└─ Puerto Descarga 2 Real (${dischPort2Name}):</td>
    ...
    return (
        <div className="flex flex-col gap-3 w-full mt-2">
            ...
            <div className="bg-slate-900 text-white p-3 rounded-xl shadow-sm flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                    ...
                    <div>
                        <h3 className="text-sm font-black uppercase tracking-wider text-slate-100">
                            ACTA DE AUDITORÍA VIAJE POR VIAJE: FORECAST VS EJECUCIÓN REAL (LEGACY)
                        </h3>
                        <p className="text-xs text-slate-400 font-mono">
                            Versión funcional legacy preservada de auditoría PDF
                        </p>
                    </div>
                </div>
                ...
                >
                    <Printer size={16} />
                    <span>Imprimir Acta PDF (Legacy)</span>
                </button>
            </div>
            ...
            <div className="flex flex-col bg-slate-200 p-4 rounded-xl border border-slate-300 shadow-inner max-h-[85vh] overflow-y-auto">
                <div className="bg-white shadow-2xl rounded border border-slate-400 p-3 min-h-[850px]">
                    <iframe
                        title="Visor PDF Auditoria Liquidaciones Legacy"
                        srcDoc={htmlDoc}
