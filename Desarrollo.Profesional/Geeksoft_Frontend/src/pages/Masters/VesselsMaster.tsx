...
import { Ship, Shield, Settings, Navigation, Fuel, Waves, Save, Edit3, Plus, Activity } from 'lucide-react';
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="flex flex-col border border-slate-200 rounded-lg overflow-hidden h-full">
                                            ...
                                            <div className="p-3 flex flex-col gap-2 font-mono text-xs flex-1">
                                                <div className="flex justify-between items-center"><span className="text-[9px] font-bold text-slate-500 uppercase">Capacidad Máx</span>{isEditing ? <input type="number" className="border border-slate-300 rounded px-1 w-16 text-right" value={editFormData?.max_capacity_ifo || ''} onChange={e => setEditFormData({...editFormData, max_capacity_ifo: Number(e.target.value)})} /> : <span className="font-bold text-slate-800">{selectedVessel.max_capacity_ifo} t</span>}</div>
                                                <div className="flex justify-between items-center border-t border-slate-100 pt-1.5"><span className="text-[9px] font-bold text-slate-500 uppercase">Navegando (Sea)</span>{isEditing ? <input type="number" step="0.1" className="border border-slate-300 rounded px-1 w-16 text-right" value={editFormData?.consumption_sea_ifo || ''} onChange={e => setEditFormData({...editFormData, consumption_sea_ifo: Number(e.target.value)})} /> : <span className="font-bold text-slate-800 text-sm">{selectedVessel.consumption_sea_ifo} t/d</span>}</div>
                                                <div className="flex justify-between items-center"><span className="text-[9px] font-bold text-slate-500 uppercase">Puerto (Port)</span>{isEditing ? <input type="number" step="0.1" className="border border-slate-300 rounded px-1 w-16 text-right" value={editFormData?.consumption_port_ifo || ''} onChange={e => setEditFormData({...editFormData, consumption_port_ifo: Number(e.target.value)})} /> : <span className="font-bold text-slate-850">{selectedVessel.consumption_port_ifo} t/d</span>}</div>
                                                <div className="flex justify-between items-center"><span className="text-[9px] font-bold text-slate-500 uppercase">Espera (Idle)</span>{isEditing ? <input type="number" step="0.1" className="border border-slate-300 rounded px-1 w-16 text-right" value={editFormData?.consumption_idle_ifo || ''} onChange={e => setEditFormData({...editFormData, consumption_idle_ifo: Number(e.target.value)})} /> : <span className="font-bold text-slate-850">{selectedVessel.consumption_idle_ifo || 0} t/d</span>}</div>
                                                <div className="flex justify-between items-center"><span className="text-[9px] font-bold text-slate-500 uppercase">Maniobra Carga</span>{isEditing ? <input type="number" step="0.1" className="border border-slate-300 rounded px-1 w-16 text-right" value={editFormData?.consumption_load_ifo || ''} onChange={e => setEditFormData({...editFormData, consumption_load_ifo: Number(e.target.value)})} /> : <span className="font-bold text-slate-850">{selectedVessel.consumption_load_ifo || 0} t/d</span>}</div>
                                                <div className="flex justify-between items-center"><span className="text-[9px] font-bold text-slate-500 uppercase">Maniobra Descarga</span>{isEditing ? <input type="number" step="0.1" className="border border-slate-300 rounded px-1 w-16 text-right" value={editFormData?.consumption_disch_ifo || ''} onChange={e => setEditFormData({...editFormData, consumption_disch_ifo: Number(e.target.value)})} /> : <span className="font-bold text-slate-850">{selectedVessel.consumption_disch_ifo || 0} t/d</span>}</div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-col border border-slate-200 rounded-lg overflow-hidden h-full">
                                            ...
                                            <div className="p-3 flex flex-col gap-2 font-mono text-xs flex-1">
                                                <div className="flex justify-between items-center"><span className="text-[9px] font-bold text-slate-500 uppercase">Capacidad Máx</span>{isEditing ? <input type="number" className="border border-slate-300 rounded px-1 w-16 text-right" value={editFormData?.max_capacity_mdo || ''} onChange={e => setEditFormData({...editFormData, max_capacity_mdo: Number(e.target.value)})} /> : <span className="font-bold text-slate-800">{selectedVessel.max_capacity_mdo} t</span>}</div>
                                                <div className="flex justify-between items-center border-t border-slate-100 pt-1.5"><span className="text-[9px] font-bold text-slate-500 uppercase">Navegando (Sea)</span>{isEditing ? <input type="number" step="0.1" className="border border-slate-300 rounded px-1 w-16 text-right" value={editFormData?.consumption_sea_mdo || ''} onChange={e => setEditFormData({...editFormData, consumption_sea_mdo: Number(e.target.value)})} /> : <span className="font-bold text-slate-800 text-sm">{selectedVessel.consumption_sea_mdo || 0} t/d</span>}</div>
                                                <div className="flex justify-between items-center"><span className="text-[9px] font-bold text-slate-500 uppercase">Espera (Idle)</span>{isEditing ? <input type="number" step="0.1" className="border border-slate-300 rounded px-1 w-16 text-right" value={editFormData?.consumption_idle_mdo || ''} onChange={e => setEditFormData({...editFormData, consumption_idle_mdo: Number(e.target.value)})} /> : <span className="font-bold text-slate-850">{selectedVessel.consumption_idle_mdo || 0} t/d</span>}</div>
                                                <div className="flex justify-between items-center"><span className="text-[9px] font-bold text-slate-500 uppercase">Maniobra Carga</span>{isEditing ? <input type="number" step="0.1" className="border border-slate-300 rounded px-1 w-16 text-right" value={editFormData?.consumption_load_mdo || ''} onChange={e => setEditFormData({...editFormData, consumption_load_mdo: Number(e.target.value)})} /> : <span className="font-bold text-slate-850">{selectedVessel.consumption_load_mdo || 0} t/d</span>}</div>
                                                <div className="flex justify-between items-center"><span className="text-[9px] font-bold text-slate-500 uppercase">Maniobra Descarga</span>{isEditing ? <input type="number" step="0.1" className="border border-slate-300 rounded px-1 w-16 text-right" value={editFormData?.consumption_disch_mdo || ''} onChange={e => setEditFormData({...editFormData, consumption_disch_mdo: Number(e.target.value)})} /> : <span className="font-bold text-slate-850">{selectedVessel.consumption_disch_mdo || 0} t/d</span>}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
