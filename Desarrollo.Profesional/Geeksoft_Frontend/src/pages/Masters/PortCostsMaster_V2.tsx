    ...
    const exportData = useMemo(() => {
        ...
        ports.forEach(portObj => {
            ...
            vessels.forEach(vesselObj => {
                ...
                // Fila Operación DEMURRAGE (Estadías Promedio)
                const dem = data.DEMURRAGE || {};
                const monthsKeys = ['m01', 'm02', 'm03', 'm04', 'm05', 'm06', 'm07', 'm08', 'm09', 'm10', 'm11', 'm12'];
                const demSum = monthsKeys.reduce((acc, mk) => acc + (Number(dem[mk]) || 0), 0);
                const demAvg = demSum / 12;
                ...
                rows.push({
                    ...
                    vessel_id: vesselId,
                    vessel_name: vesselName,
                    operation: 'Demurrage Promedio (Días)',
                    main_cost: demAvg,
                    lm_cost: 0,
                    muellaje_cost: 0,
                    survey_cost: 0,
