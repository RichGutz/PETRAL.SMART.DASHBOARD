...
def generate_er_diagram():
    ...
    digraph ERCostosPortuarios {
        ...
        VESSEL_TERMINAL_OPERATIONS [label="{VESSEL_TERMINAL_OPERATIONS (Matriz Op.)|port_id (PK, FK)\\nterminal_id (PK, FK)\\nvessel_id (PK, FK)\\nritmo_carga\\namarre_hrs\\nmaniobras\\nremolcadores\\nlanchas\\nturnos_coordinador\\n...}", fillcolor="#FFCCBC", color="#D84315", penwidth=2];
        ...
        VESSEL_TERMINAL_OPERATIONS -> CALCULATOR_INPUTS [label=" Inyecta variables operativas al simulador ", color="#D84315", style="dashed", dir="forward", fontcolor="#D84315"];
