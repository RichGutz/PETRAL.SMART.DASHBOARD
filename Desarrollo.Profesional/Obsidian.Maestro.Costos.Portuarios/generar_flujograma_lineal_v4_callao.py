...
def generate_v4_diagram():
    ...
    dot = graphviz.Digraph(name="CALLAO_LINEAL_V4")
    ...
    # --- THE FIX: Force vertical ordering for all nodes in the same column ---
    ...
    filename = "Flujograma_Lineal_V4_CALLAO"
