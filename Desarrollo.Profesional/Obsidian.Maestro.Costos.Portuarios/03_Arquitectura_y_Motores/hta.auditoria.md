...
## 🎨 3. Regla de Diseño Estricta: Fidelidad 1:1 con la Estructura de los Excels

> ⚠️ **REGLA DE DISEÑO OBLIGATORIA (INVARIABLE)**:  
> Toda interfaz de usuario (UI), panel de auditoría, cotizador o informe PDF donde se presenten las dimensiones $P$ y $Q$ **DEBE reflejar exactamente la estructura, nombres de conceptos, subtotales y columnas de los Excels originales de las expertas por puerto** (`Callao`, `Marcona`, `Matarani`, `Ilo`), desglosados en los 3 bloques navieros (`A_SHIFTING`, `B_GENERAL_PORT`, `C_AGENCY`).

---

## 🖼️ 4. Arquitectura Visual: Visor Dual Lado a Lado (Split-View)
