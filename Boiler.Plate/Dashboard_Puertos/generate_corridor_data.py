...
MINE_ROUTE_CONFIGS = {
    ...
    "Los Chancas": {
        ...
        "capacity": "Ref Max: 106 camiones/día"
    },
    "Trapiche": {
...
def generate_pe30a():
    print("\n--- Generating Missing Road PE-30A ---")
    # PE-30A: Nazca -> Puquio -> Chalhuanca -> Abancay
    # Start: Nazca (PE-1S junction) -> -14.83, -74.93
    # Mid1: Puquio -> -14.69, -74.12
    # Mid2: Chalhuanca -> -14.29, -73.24
    # End: Abancay -> -13.63, -72.88
    ...
    # Using multiple waypoints to ensure it follows the highway
    route = get_osrm_route(start, end, waypoints=[mid1, mid2])
    ...
    if route:
        ...
        js_content = f"const ROAD_PE30A = {json.dumps(feature, indent=2)};"
        with open(r"C:\Users\rguti\Petral.MARK\Dashboard_Puertos\road_pe30a.js", "w", encoding="utf-8") as f:
            f.write(js_content)
            
        print("Successfully generated PE-30A geometry.")
    else:
        print("Failed to route PE-30A.")
