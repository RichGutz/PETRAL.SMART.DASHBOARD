...
// Ubicación: C:\Users\rguti\Petral.MARK\Dashboard_Puertos\Graficos.25.05.26\script_local2_V23.js
//
// AISLAMIENTO TOTAL: Solo cargado por grafico2.html. Dashboard de producción intacto.
// ==============================================================================

console.log("🔄 [G2] Iniciando personalización Gráfico 2 (Versión 23)...");
...
if (typeof CONFIG === 'undefined') {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        setTimeout(() => {
            ...
            console.log("⚓ [G2-V23] Burbuja San Nicolás reposicionada y centrada sin sombra.");
    ...
    console.log("✅ [G2] Configuración V23 cargada.");
}
